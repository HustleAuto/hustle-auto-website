  ...
  return (
    <main className="container mx-auto my-20 prose">
      ...
      <p>
        ...
        be three (3). The seat, or legal place, of arbitration shall be Calgary,
        Canada. The language of the proceedings shall be English. The governing
        law of the contract shall be the substantive law of Canada.
      </p>
      ...
      <p>
        ...
        PAID, IF ANY, BY YOU TO US OR $20.00 USD. CERTAIN US STATE LAWS AND
